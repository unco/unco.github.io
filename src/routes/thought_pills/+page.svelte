<script>
    ...
    import Glyph from '../toys/[toy]/glyph.svelte';
    ...
    let mbs = [
        {
            ...
            "img": {
                url: "mb17.png",
                alt: "A screenshot of the original product 'Glitch' that birthed Slack"
            }
        },
        {
            "mb": 18,
        ...
        },
        {
            ...
            "img": {
                url: "mb19.png",
                alt: "'Inside Out' (2013) / Richard Serra"
            },
            "quote": {
                text: "You had to pay attention all the time to everything that was going on",
        ...
        },
        {
            ...
            "img": {
                url: "mb20.png",
                alt: "Amazon smile tweak"
            },
            "quote": {
                text: "Find joy in everything you choose to do. It is your responsibility to love it or change it.",
                attr: "Chuck Palahniuk (American Novelist)"
            }
        },
        {
            "mb": 21,
            ...
            "img": {
                url: "mb21.png",
                alt: "Ugly diagram, interesting process... look familiar?"
            }
        },
        {
            "mb": 23,
            ...
            "img": {
                url: "mb23.png",
                alt: "UX / SRR alignment makes complete sense"
            }
        },
        {
            "mb": 25,
        ...
        },
        {
            ...
            "img": {
                url: "mb28.png",
                alt: "Interactive logo that was available for a short time only"
            }
        },
        {
            "mb": 29,
            ...
            "quote": {
                text: "Estimate how likely a design decision is to create user behavior change around your problem — SRR tip",
                attr: "Hayden"
            }
        },
        {
            ...
            "img": {
                url: "mb30.png",
                alt: "Must be right, he has a Computer Science beard"
            }
        },
        {
            "mb": 31,
        ...
        },
        {
            ...
            "img": {
                url: "mb32.png",
                alt: "Are our products liminal spaces?"
            }
        },
        {
            "mb": 33,
        ...
        },
        {
            ...
            "img": {
                url: "mb34.png",
                alt: "Be regular and orderly in your life, so that you may be violent and original in your work."
            }
        },
        {
            "mb": 35,
            "author": "Dani (Podcast edition)",
            "pills": [
                {
        ...
        },
        {
            ...
            "quote": {
                text: "Authenticity is the currency of the future",
                attr: "Some youtube commenter"
            }
        },
        {
            "mb": 37,
            ...
            "img": {
                url: "mb37.png",
                alt: "Quiz: Icons should be centered on the...? Why?"
            }
        },
        {
            "mb": 38,
   ...
   let mbs_ordered = mbs.sort((a, b) => b.mb - a.mb);
    ...
    // Derive unique tags from all pills
    ...
    // Filtered view — if no filters active, show all
    $: filteredMbs = activeFilters.size === 0
        ? mbs_ordered
        : mbs_ordered
            .map(mb => ({
                ...mb,
                pills: mb.pills.filter(pill =>
                    [...activeFilters].some(tag => pill.tags.includes(tag))
                )
            }))
...
<table>
    {#each filteredMbs as mb}
    <tr>
        <td>
            <h2>Minibus {mb.mb} - by {mb.author}</h2>
            <ul>
                {#each mb.pills as pill}
                    <li>
                        {#if pill.url == '#'}
                        {@html pill.text}
                        {:else}
                        <a href="{pill.url}" target="_blank" title="{pill.description}">{pill.text}</a>
                        {/if}
                        {#each pill.tags as tag}
                            <span class='tag tag_{tag}'
                            class:active={activeFilters.has(tag)}>{tag}</span>
                        {/each}
                    </li>
                {/each}
            </ul>
